...
const DEFAULT_DATA: AccountabilityData = {
	hero: {
		...
		description:
			"Pesona Kebaikan berkomitmen untuk menjaga amanah donatur dengan standar transparansi dan akuntabilitas tertinggi.",
	},
	cards: [
		{
			icon: "audit",
...
export default function AdminAkuntabilitasPage() {
	...
	const handleHeroChange = (
		field: keyof AccountabilityData["hero"],
		value: string,
	) => {
	...
	const handleCardChange = (
		index: number,
		field: keyof AccountabilityData["cards"][0],
		value: string,
	) => {
	...
	const handleReportChange = (
		index: number,
		field: keyof AccountabilityData["reports"][0],
		value: string,
	) => {
			...
			<Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
				...
				>
					...
					>
						...
						<Button startIcon={<AddIcon />} size="small" onClick={addCard}>
							Tambah
						</Button>
					</Box>
					<Grid container spacing={2}>
								...
								<Grid container spacing={2}>
									<Grid size={{ xs: 12, sm: 2 }}>
										<TextField
											...
											value={report.year}
											onChange={(e) =>
												handleReportChange(index, "year", e.target.value)
											}
											size="small"
										/>
									</Grid>
									<Grid size={{ xs: 12, sm: 5 }}>
										<TextField
											...
											value={report.title}
											onChange={(e) =>
												handleReportChange(index, "title", e.target.value)
											}
											size="small"
										/>
									</Grid>
