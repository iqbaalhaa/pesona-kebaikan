...
/* ---------- category config ---------- */
// TODO: Fetch these from API or align with database
const CATEGORIES = [
  ...
  React.useEffect(() => {
    ...
    const fetchBlog = async () => {
      try {
        ...
        setForm({
          title: data.title || "",
          categoryId: data.categoryId || data.category?.id || "general",
        ...
        setToast({ open: true, msg: "Failed to load blog: " + e.message, severity: "error" });
      } finally {
        setLoading(false);
      }
    };
