    ...
    <Box sx={{ px: 2.5, pt: 2.5, pb: 6 }}>
      ...
      >
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Box sx={{ mt: 0.5, display: "flex", alignItems: "center", gap: 0.5 }}>
            ...
            <Typography sx={{ fontSize: 11, fontWeight: 700, color: "#61ce70" }}>
              {user.memberStatus}
            </Typography>
          </Box>
        </Box>
        <Button variant="outlined" size="small" onClick={handleOpenEdit}>Ubah Profil</Button>
      </Paper>
        ...
        <List disablePadding>
          <ListItem sx={{ px: 1.5 }}>
            <ListItemText
              ...
              secondary={user.name}
              primaryTypographyProps={{ fontSize: 12, color: "rgba(15,23,42,0.6)" }}
              secondaryTypographyProps={{ fontSize: 14, fontWeight: 700, color: "#0f172a" }}
            />
          </ListItem>
          <Divider />
          <ListItem sx={{ px: 1.5 }}>
      ...
      <Dialog open={openEdit} onClose={() => setOpenEdit(false)} fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleSaveEdit}>Simpan</Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
